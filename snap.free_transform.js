        ...
        var freeTransform = function(subject, options, callback) {
            ...
            ft.showHandles = function() {
                ...
                ft.axes.map(function(axis) {
                    ...
                    ft.handles[axis].disc.drag(function(dx, dy) {
                        ...
                        ft.handles[axis].disc.ox = this.attr('cx');
                        ft.handles[axis].disc.oy = this.attr('cy');
            ...
            */
                ...
                ( subject.type === 'set' ? subject.items : [ subject ] ).map(function(item) {
                    if ( item.type === 'set' ) {
                        ...
                        ft.items.push({
                            ...
                            transformString: null //item.matrix.toTransformString()
                        });
                    }
                });
            }
            ...
            function getPaperSize() {
                ...
                return {
                    x: parseInt(paper.attr('width'),10),
                    y: parseInt(paper.attr('height'),10)
                }
            }
